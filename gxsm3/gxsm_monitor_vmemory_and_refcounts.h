...
#ifdef GXSM_MONITOR_VMEMORY_USAGE
#define GXSM_LOG_DATAOBJ_ACTION(ID, WHAT) gapp->monitorcontrol->LogEvent(grc_name[ID], WHAT);
#define GXSM_LOG_ANY_ACTION(ID, WHAT) gapp->monitorcontrol->LogEvent(ID, WHAT);
