...
#    "axis_4s_combine.v"
#    "axis_bram_push.v"
#    "VolumeAdjuster16_14.v"
#    "axis_dc_filter.v"
#    "axis_decimator.v"
#    "axis_sc28_to_14.v"
#    "LED_connect.v"
#    "lms_phase_amplitude_detector.v"
#    "comparator.v"
#    "system_wrapper.v"
#    "logic_or.v"
#    "cfg_axis_select.v"
...
#    "ArrithmeticShift.v"
#    "port_slicer.v"
#    "testbeds/lms_phase_amplitude_detector_tb.v"
#    "testbeds/controller_pi_tb.v"
#    "testbeds/axis_4s_combine_tb.v"
#    "testbeds/SineSDB64_tb.v"
#    "testbeds/lms_pad_sim.v"
#    "testbeds/McBSP_tb.v"
#
...
#    "cfg/ports.xdc"
#    "cfg/clocks.xdc"
#    "testbeds/SineSDB64_tb_behav1.wcfg"
#
#*****************************************************************************************
...
set files [list \
 [file normalize "${origin_dir}/sources/controller_pi.v"]\
 [file normalize "${origin_dir}/sources/cfg_to_axis.v"]\
 [file normalize "${origin_dir}/sources/cfg_select.v"]\
 [file normalize "${origin_dir}/sources/phase_unwrap.v"]\
 [file normalize "${origin_dir}/sources/McBSP_controller.v"]\
 [file normalize "${origin_dir}/sources/McBSP_io_connect.v"]\
 [file normalize "${origin_dir}/sources/ScaleAndAdjust.v"]\
 [file normalize "${origin_dir}/sources/axis_4s_combine.v"]\
 [file normalize "${origin_dir}/sources/axis_bram_push.v"]\
 [file normalize "${origin_dir}/sources/VolumeAdjuster16_14.v"]\
 [file normalize "${origin_dir}/sources/axis_dc_filter.v"]\
 [file normalize "${origin_dir}/sources/axis_decimator.v"]\
 [file normalize "${origin_dir}/sources/axis_sc28_to_14.v"]\
 [file normalize "${origin_dir}/sources/LED_connect.v"]\
 [file normalize "${origin_dir}/sources/lms_phase_amplitude_detector.v"]\
 [file normalize "${origin_dir}/sources/comparator.v" ]\
 [file normalize "${origin_dir}/sources/system_wrapper.v"]\
 [file normalize "${origin_dir}/sources/logic_or.v"]\
 [file normalize "${origin_dir}/sources/cfg_axis_select.v"]\
 [file normalize "${origin_dir}/sources/axis_ram_writer.v"]\
 [file normalize "${origin_dir}/sources/signal_combine.v"]\
 [file normalize "${origin_dir}/sources/split_signal.v"]\
 [file normalize "${origin_dir}/sources/SineSDB64.v"]\
 [file normalize "${origin_dir}/sources/Signed16toQ22.v"]\
 [file normalize "${origin_dir}/sources/SignedQ31toQ22.v"]\
 [file normalize "${origin_dir}/sources/ArrithmeticShift.v"]\
 [file normalize "${origin_dir}/sources/port_slicer.v"]\
]
...
# Import local files from the original project
set files [list \
 [file normalize "${origin_dir}/testbeds/lms_phase_amplitude_detector_tb.v"]\
 [file normalize "${origin_dir}/testbeds/controller_pi_tb.v"]\
 [file normalize "${origin_dir}/testbeds/axis_4s_combine_tb.v"]\
 [file normalize "${origin_dir}/testbeds/SineSDB64_tb.v"]\
]
...
# Import local files from the original project
set files [list \
 [file normalize "${origin_dir}/testbeds/lms_pad_sim.v"]\
]
...
# Import local files from the original project
set files [list \
 [file normalize "${origin_dir}/testbeds/McBSP_tb.v"]\
]
...
if { [get_files controller_pi.v] == "" } {
  import_files -quiet -fileset sources_1 controller_pi.v
}
if { [get_files cfg_to_axis.v] == "" } {
  import_files -quiet -fileset sources_1 cfg_to_axis.v
}
if { [get_files cfg_to_axis.v] == "" } {
  import_files -quiet -fileset sources_1 cfg_to_axis.v
}
...
if { [get_files cfg_select.v] == "" } {
  import_files -quiet -fileset sources_1 cfg_select.v
}
if { [get_files cfg_to_axis.v] == "" } {
  import_files -quiet -fileset sources_1 cfg_to_axis.v
}
...
if { [get_files phase_unwrap.v] == "" } {
  import_files -quiet -fileset sources_1 phase_unwrap.v
}
if { [get_files McBSP_controller.v] == "" } {
  import_files -quiet -fileset sources_1 McBSP_controller.v
}
if { [get_files McBSP_io_connect.v] == "" } {
  import_files -quiet -fileset sources_1 McBSP_io_connect.v
}
if { [get_files ScaleAndAdjust.v] == "" } {
  import_files -quiet -fileset sources_1 ScaleAndAdjust.v
}
if { [get_files axis_4s_combine.v] == "" } {
  import_files -quiet -fileset sources_1 axis_4s_combine.v
}
if { [get_files axis_bram_push.v] == "" } {
  import_files -quiet -fileset sources_1 axis_bram_push.v
}
if { [get_files cfg_to_axis.v] == "" } {
  import_files -quiet -fileset sources_1 cfg_to_axis.v
}
...
if { [get_files VolumeAdjuster16_14.v] == "" } {
  import_files -quiet -fileset sources_1 VolumeAdjuster16_14.v
}
if { [get_files axis_dc_filter.v] == "" } {
  import_files -quiet -fileset sources_1 axis_dc_filter.v
}
if { [get_files axis_decimator.v] == "" } {
  import_files -quiet -fileset sources_1 axis_decimator.v
}
if { [get_files axis_sc28_to_14.v] == "" } {
  import_files -quiet -fileset sources_1 axis_sc28_to_14.v
}
if { [get_files cfg_select.v] == "" } {
  import_files -quiet -fileset sources_1 cfg_select.v
}
...
if { [get_files LED_connect.v] == "" } {
  import_files -quiet -fileset sources_1 LED_connect.v
}
if { [get_files lms_phase_amplitude_detector.v] == "" } {
  import_files -quiet -fileset sources_1 lms_phase_amplitude_detector.v
}
if { [get_files comparator.v] == "" } {
  import_files -quiet -fileset sources_1 comparator.v
}
if { [get_files cfg_to_axis.v] == "" } {
  import_files -quiet -fileset sources_1 cfg_to_axis.v
}
