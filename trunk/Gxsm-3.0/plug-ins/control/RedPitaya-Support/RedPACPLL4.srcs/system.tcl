...
# module references:
# VolumeAdjuster16_14, axis_sc28_to_14, cfg_select, cfg_select, cfg_select, cfg_select, cfg_select, cfg_to_axis, cfg_to_axis, cfg_to_axis, cfg_to_axis, cfg_to_axis, cfg_to_axis, led_connect, lms_phase_amplitude_detector, controller_pi, cfg_to_axis, cfg_to_axis, cfg_to_axis, cfg_to_axis, cfg_to_axis, cfg_to_axis, cfg_select, cfg_to_axis, cfg_to_axis, cfg_to_axis, cfg_to_axis, cfg_to_axis, cfg_to_axis, logic_or, controller_pi, phase_unwrap, McBSP_controller, McBSP_io_connect, ScaleAndAdjust, axis_4s_combine, cfg_to_axis, cfg_to_axis, cfg_to_axis, cfg_to_axis, cfg_to_axis, cfg_to_axis
...
proc create_hier_cell_PS_data_transport { parentCell nameHier } {
  ...
  connect_bd_net -net axis_4s_combine_0_bram_porta_addr [get_bd_pins axis_4s_combine_0/bram_porta_addr] [get_bd_pins blk_mem_gen_0/addra]
  connect_bd_net -net axis_4s_combine_0_bram_porta_clk [get_bd_pins axis_4s_combine_0/bram_porta_clk] [get_bd_pins blk_mem_gen_0/clka]
  connect_bd_net -net axis_4s_combine_0_bram_porta_en [get_bd_pins axis_4s_combine_0/bram_porta_en] [get_bd_pins blk_mem_gen_0/ena]
  connect_bd_net -net axis_4s_combine_0_bram_porta_we [get_bd_pins axis_4s_combine_0/bram_porta_we] [get_bd_pins blk_mem_gen_0/wea]
  connect_bd_net -net axis_4s_combine_0_bram_porta_wrdata [get_bd_pins axis_4s_combine_0/bram_porta_wrdata] [get_bd_pins blk_mem_gen_0/dina]
...
proc create_hier_cell_PS_Phase_Controller { parentCell nameHier } {
  ...
  set block_cell_name logic_or_0
  if { [catch {set logic_or_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $logic_or_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  set block_cell_name phase_unwrap_0
  if { [catch {set phase_unwrap_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $phase_unwrap_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_intf_net -intf_net S_AXIS_1 [get_bd_intf_pins S_AXIS] [get_bd_intf_pins phase_unwrap_0/S_AXIS]
  ...
  connect_bd_intf_net -intf_net phase_unwrap_0_M_AXIS [get_bd_intf_pins phase_controller/S_AXIS] [get_bd_intf_pins phase_unwrap_0/M_AXIS]
  ...
  connect_bd_net -net axis_red_pitaya_adc_0_adc_clk [get_bd_pins aclk] [get_bd_pins cfg_to_axis_PhaseInc/a_clk] [get_bd_pins cfg_to_ph_ci/a_clk] [get_bd_pins cfg_to_ph_cp/a_clk] [get_bd_pins cfg_to_ph_lower/a_clk] [get_bd_pins cfg_to_ph_setpoint/a_clk] [get_bd_pins cfg_to_ph_upper/a_clk] [get_bd_pins phase_controller/aclk] [get_bd_pins phase_unwrap_0/aclk]
  connect_bd_net -net cfg_select_phase_unwrapping_status [get_bd_pins cfg_select_phase_unwrapping/status] [get_bd_pins logic_or_0/B]
  ...
  connect_bd_net -net enable_1 [get_bd_pins enable] [get_bd_pins logic_or_0/A] [get_bd_pins phase_controller/enable]
  connect_bd_net -net logic_or_0_AorB [get_bd_pins logic_or_0/AorB] [get_bd_pins phase_unwrap_0/enable]
...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net axis_red_pitaya_adc_0_M_AXIS [get_bd_intf_pins axis_red_pitaya_adc_0/M_AXIS] [get_bd_intf_pins lms_phase_amplitude_detector_0/S_AXIS_SIGNAL]
  ...
  connect_bd_intf_net -intf_net lms_phase_amplitude_detector_0_M_AXIS_MDC [get_bd_intf_pins PS_data_transport/S_AXIS7] [get_bd_intf_pins lms_phase_amplitude_detector_0/M_AXIS_MDC]
  ...
  connect_bd_intf_net -intf_net lms_phase_amplitude_detector_0_M_AXIS_SIGNAL [get_bd_intf_pins PS_data_transport/S_AXIS1] [get_bd_intf_pins lms_phase_amplitude_detector_0/M_AXIS_SIGNAL]
  connect_bd_intf_net -intf_net lms_phase_amplitude_detector_0_M_AXIS_SIGNAL_M [get_bd_intf_pins VolumeAdjuster16_14_and_QCtrl/S_AXIS_SIGNAL_M] [get_bd_intf_pins lms_phase_amplitude_detector_0/M_AXIS_SIGNAL_M]
  ...
  connect_bd_net -net PS_data_transport_debug [get_bd_pins PS/gpio_io_5_x12] [get_bd_pins PS_data_transport/debug]
  ...
  connect_bd_net -net PS_data_transport_writeposition [get_bd_pins PS/gpio_io_5_x11] [get_bd_pins PS_data_transport/writeposition]
  ...
  connect_bd_net -net cfg_to_axis_dc_M_AXIS_tdata [get_bd_pins cfg_to_axis_dc/M_AXIS_tdata] [get_bd_pins lms_phase_amplitude_detector_0/dc]
  connect_bd_net -net cfg_to_axis_dc_tau_M_AXIS_tdata [get_bd_pins cfg_to_axis_dc_tau/M_AXIS_tdata] [get_bd_pins lms_phase_amplitude_detector_0/dc_tau]
  ...
  connect_bd_net -net lms_phase_amplitude_detector_0_Aout [get_bd_pins PS/gpio_io_0_x1] [get_bd_pins lms_phase_amplitude_detector_0/Aout]
  connect_bd_net -net lms_phase_amplitude_detector_0_Bout [get_bd_pins PS/gpio_io_0_x2] [get_bd_pins lms_phase_amplitude_detector_0/Bout]
  connect_bd_net -net lms_phase_amplitude_detector_0_dbg1 [get_bd_pins PS/gpio_io_1_x3] [get_bd_pins lms_phase_amplitude_detector_0/dbg1]
  connect_bd_net -net lms_phase_amplitude_detector_0_dbg2 [get_bd_pins PS/gpio_io_2_x5] [get_bd_pins lms_phase_amplitude_detector_0/dbg2]
  ...
  create_bd_addr_seg -range 0x00200000 -offset 0x40000000 [get_bd_addr_spaces PS/processing_system7_0/Data] [get_bd_addr_segs PS/axi_bram_reader_0/s00_axi/reg0] SEG_axi_bram_reader_0_reg0
  create_bd_addr_seg -range 0x00001000 -offset 0x42000000 [get_bd_addr_spaces PS/processing_system7_0/Data] [get_bd_addr_segs PS/axi_cfg_register_0/s_axi/reg0] SEG_axi_cfg_register_0_reg0
  create_bd_addr_seg -range 0x00001000 -offset 0x42001000 [get_bd_addr_spaces PS/processing_system7_0/Data] [get_bd_addr_segs PS/axi_gpio_0/S_AXI/Reg] SEG_axi_gpio_0_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0x42002000 [get_bd_addr_spaces PS/processing_system7_0/Data] [get_bd_addr_segs PS/axi_gpio_1/S_AXI/Reg] SEG_axi_gpio_1_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0x42003000 [get_bd_addr_spaces PS/processing_system7_0/Data] [get_bd_addr_segs PS/axi_gpio_2/S_AXI/Reg] SEG_axi_gpio_2_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0x42004000 [get_bd_addr_spaces PS/processing_system7_0/Data] [get_bd_addr_segs PS/axi_gpio_3/S_AXI/Reg] SEG_axi_gpio_3_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0x42005000 [get_bd_addr_spaces PS/processing_system7_0/Data] [get_bd_addr_segs PS/axi_gpio_4/S_AXI/Reg] SEG_axi_gpio_4_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0x42006000 [get_bd_addr_spaces PS/processing_system7_0/Data] [get_bd_addr_segs PS/axi_gpio_5/S_AXI/Reg] SEG_axi_gpio_5_Reg
