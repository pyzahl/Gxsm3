...
##			separator.show()
			...
			hb = gobject.new(gtk.HBox(spacing=10))
                        ...
                        hb.pack_start(button)
                        button = gtk.Button("Lx8")
                        button.connect("clicked", self.mk3spm.dsp_enable_McBSP, 8)
                        hb.pack_start(button)
                        button = gtk.Button("Lx9")
                        button.connect("clicked", self.mk3spm.dsp_enable_McBSP, 8)
                        hb.pack_start(button)
