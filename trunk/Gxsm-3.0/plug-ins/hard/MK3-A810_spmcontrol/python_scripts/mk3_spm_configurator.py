...
##			separator.show()
			...
			hb = gobject.new(gtk.HBox(spacing=10))
                        box2.pack_start(hb)
                        button = gtk.Button("McBSP ON")
                        button.connect("clicked", self.mk3spm.dsp_enable_McBSP, 0)
                        hb.pack_start(button)
                        button = gtk.Button("McBSP RST")
                        button.connect("clicked", self.mk3spm.dsp_reset_McBSP, 0)
                        hb.pack_start(button)
                        button = gtk.Button("McBSP TST")
                        button.connect("clicked", self.mk3spm.dsp_test_McBSP, 0)
                        hb.pack_start(button)
                        button = gtk.Button("McBSP N=1")
                        button.connect("clicked", self.mk3spm.dsp_test_McBSP, 1)
                        hb.pack_start(button)
                        button = gtk.Button("McBSP N=2")
                        button.connect("clicked", self.mk3spm.dsp_test_McBSP, 2)
                        hb.pack_start(button)
                        button = gtk.Button("McBSP N=3")
                        button.connect("clicked", self.mk3spm.dsp_test_McBSP, 3)
                        hb.pack_start(button)
                        button = gtk.Button("McBSP N=4")
                        button.connect("clicked", self.mk3spm.dsp_test_McBSP, 4)
                        hb.pack_start(button)
                        button = gtk.Button("McBSP N=8")
                        button.connect("clicked", self.mk3spm.dsp_test_McBSP, 8)
                        hb.pack_start(button)
