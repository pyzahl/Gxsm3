...
// OLD may not work any more:  g++ `pkg-config --libs  --cflags glib-2.0` mk3_reset.C -o mk3_reset
// g++ `pkg-config --cflags glib-2.0` -o mk3_reset mk3_reset.C `pkg-config --libs glib-2.0`
