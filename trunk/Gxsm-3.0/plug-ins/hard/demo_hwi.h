 ...
 * =================================================================
 */
class demo_hwi_dev : public XSM_Hardware{

public: 
	friend class Demo_SPM_Control;

	demo_hwi_dev();
	virtual ~demo_hwi_dev();
...
// Demo format conversions and endianess adaptions

	int is_scanning() { return ScanningFlg; };
protected:
	int ScanningFlg;
	int KillFlg;
	int dsp; // connection to Demo
 ...
 * ======================================================================
 */
class demo_hwi_spm : public demo_hwi_dev{
 public:
	demo_hwi_spm();
	virtual ~demo_hwi_spm();
