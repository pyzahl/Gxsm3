...
void MonitorControl::AppWindowInit(const gchar *title){
	...
	// GtkIconSize tmp_toolbar_icon_size = GTK_ICON_SIZE_LARGE_TOOLBAR;
        ...
        gtk_menu_button_set_popup (GTK_MENU_BUTTON (header_menu_button), monitor_menu);
...
void MonitorControl::LogEvent (const gchar *Action, const gchar *Entry, gint level){
        if (logging_level >= level){
	        ...
	        GTimeVal gt;
                ...
                //gchar *tmp = g_date_time_format (gdt);
