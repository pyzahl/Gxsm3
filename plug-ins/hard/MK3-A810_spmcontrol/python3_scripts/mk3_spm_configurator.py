...
class SignalScope():
    ...
    def __init__(self, parent, mode="", single_shot=0, blen=5000):
        ...
        if name not in parent.wins:
                ...
                table = Gtk.Table(n_rows=4, n_columns=6)
                ...
                table.attach(Samples, 3, 4, tr+1, tr+2)
                Samples.show()
                ...
                lab = Gtk.Label (label="Scale/Div")
                table.attach(lab, 0, 1, tr+1, tr+2)
                Xscale = Gtk.Entry()
                Xscale.set_text("1.")
                table.attach(Xscale, 1, 2, tr+1, tr+2)
                Xscale.show()
                ...
                combo.show ()
                table.attach(combo, 2, 3, tr, tr+1)
                Yscale = Gtk.Entry()
                Yscale.set_text("1.")
                table.attach(Yscale, 2, 3, tr+1, tr+2)
                Yscale.show()

                tr = tr+2
                lab = Gtk.Label (label="Average")
                table.attach(lab, 0, 1, tr+0, tr+1)
                lab = Gtk.Label (label="Offset")
                table.attach(lab, 0, 1, tr+1, tr+2)
                labx0 = Gtk.Label( label="X-off:")
                labx0.show ()
                table.attach(labx0, 1, 2, tr, tr+1)
                Xoff = Gtk.Entry()
                Xoff.set_text("0")
                table.attach(Xoff, 1, 2, tr+1, tr+2)
                Xoff.show()
                laby0 = Gtk.Label( label="Y-off:")
                laby0.show ()
                table.attach(laby0, 2, 3, tr, tr+1)
                Yoff = Gtk.Entry()
                Yoff.set_text("0")
                table.attach(Yoff, 2, 3, tr+1, tr+2)
                Yoff.show()
                ...
                table.attach(self.hb, 3, 4, tr, tr+1)
                tr = tr+1
                ...
                table.attach(self.trigger_button, 3, 4, tr, tr+1)
