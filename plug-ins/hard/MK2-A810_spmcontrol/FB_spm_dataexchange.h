...
#define FB_SPM_VERSION   0x2042 /* FB_SPM main Version, BCD: 00.00 */
#define FB_SPM_DATE_YEAR 0x2023 /* Date: Year, BCD */
#define FB_SPM_DATE_MMDD 0x0113 /* Date: Month/Day, BCD */
