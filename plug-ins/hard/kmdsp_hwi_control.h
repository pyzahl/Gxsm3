...
class kmdsp_SPM_Control : public AppBase{
	friend class kmdsp_hwi_dev;
...
#define FLAG_AUTO_PLOT   0x02 // auto plot
 ...
 public:
	...
	gint SetUserParam (gint n, gchar *id, double value);
        ...
        static int ChangedAction(GtkWidget *widget, kmdsp_SPM_Control *dspc);
        static int feedback_callback(GtkWidget *widget, kmdsp_SPM_Control *dspc);
        static int se_auto_trigger_callback(GtkWidget *widget, kmdsp_SPM_Control *dspc);
        static int choice_Ampl_callback(GtkWidget *widget, kmdsp_SPM_Control *dspc);
        static int auto_probe_callback(GtkWidget *widget, kmdsp_SPM_Control *dspc);
	static int LockIn_exec_callback(GtkWidget *widget, kmdsp_SPM_Control *dspc);
	static int LockIn_read_callback(GtkWidget *widget, kmdsp_SPM_Control *dspc);
	static int LockIn_write_callback(GtkWidget *widget, kmdsp_SPM_Control *dspc);
	static int Probing_exec_IV_callback(GtkWidget *widget, kmdsp_SPM_Control *dspc);
	static int Probing_write_IV_callback(GtkWidget *widget, kmdsp_SPM_Control *dspc);
	static int Probing_exec_FZ_callback(GtkWidget *widget, kmdsp_SPM_Control *dspc);
	static int Probing_write_FZ_callback(GtkWidget *widget, kmdsp_SPM_Control *dspc);
	static int Probing_exec_PL_callback(GtkWidget *widget, kmdsp_SPM_Control *dspc);
	static int Probing_write_PL_callback(GtkWidget *widget, kmdsp_SPM_Control *dspc);
	static int Probing_exec_LP_callback(GtkWidget *widget, kmdsp_SPM_Control *dspc);
	static int Probing_write_LP_callback(GtkWidget *widget, kmdsp_SPM_Control *dspc);
	static int Probing_exec_SP_callback(GtkWidget *widget, kmdsp_SPM_Control *dspc);
	static int Probing_write_SP_callback(GtkWidget *widget, kmdsp_SPM_Control *dspc);
	static int Probing_exec_TS_callback(GtkWidget *widget, kmdsp_SPM_Control *dspc);
	static int Probing_write_TS_callback(GtkWidget *widget, kmdsp_SPM_Control *dspc);
	static int Probing_exec_LM_callback(GtkWidget *widget, kmdsp_SPM_Control *dspc);
	static int Probing_write_LM_callback(GtkWidget *widget, kmdsp_SPM_Control *dspc);
	static int Probing_exec_AX_callback(GtkWidget *widget, kmdsp_SPM_Control *dspc);
	static int Probing_write_AX_callback(GtkWidget *widget, kmdsp_SPM_Control *dspc);
	static int Probing_exec_RF_callback(GtkWidget *widget, kmdsp_SPM_Control *dspc);
//	static int Probing_eventcheck_callback(GtkWidget *widget, kmdsp_SPM_Control *dspc);
	static int Probing_graph_callback(GtkWidget *widget, kmdsp_SPM_Control *dspc);
	static int Probing_save_callback(GtkWidget *widget, kmdsp_SPM_Control *dspc);
	static int Probing_abort_callback(GtkWidget *widget, kmdsp_SPM_Control *dspc);
        static int change_source_callback (GtkWidget *widget, kmdsp_SPM_Control *dspc);
	static int callback_change_AC_option_flags (GtkWidget *widget, kmdsp_SPM_Control *dspc);
	static int callback_change_AC_auto_flags (GtkWidget *widget, kmdsp_SPM_Control *dspc);
	static int callback_change_IV_option_flags (GtkWidget *widget, kmdsp_SPM_Control *dspc);
	static int callback_change_IV_auto_flags (GtkWidget *widget, kmdsp_SPM_Control *dspc);
	static int callback_change_FZ_option_flags (GtkWidget *widget, kmdsp_SPM_Control *dspc);
	static int callback_change_FZ_auto_flags (GtkWidget *widget, kmdsp_SPM_Control *dspc);
	static int callback_change_PL_option_flags (GtkWidget *widget, kmdsp_SPM_Control *dspc);
	static int callback_change_PL_auto_flags (GtkWidget *widget, kmdsp_SPM_Control *dspc);
	static int callback_change_LP_option_flags (GtkWidget *widget, kmdsp_SPM_Control *dspc);
	static int callback_change_LP_auto_flags (GtkWidget *widget, kmdsp_SPM_Control *dspc);
	static int callback_change_SP_option_flags (GtkWidget *widget, kmdsp_SPM_Control *dspc);
	static int callback_change_SP_auto_flags (GtkWidget *widget, kmdsp_SPM_Control *dspc);
	static int callback_change_TS_option_flags (GtkWidget *widget, kmdsp_SPM_Control *dspc);
	static int callback_change_TS_auto_flags (GtkWidget *widget, kmdsp_SPM_Control *dspc);
	static int callback_change_LM_option_flags (GtkWidget *widget, kmdsp_SPM_Control *dspc);
	static int callback_change_LM_auto_flags (GtkWidget *widget, kmdsp_SPM_Control *dspc);
	static int callback_change_AX_option_flags (GtkWidget *widget, kmdsp_SPM_Control *dspc);
	static int callback_change_AX_auto_flags (GtkWidget *widget, kmdsp_SPM_Control *dspc);
	static int DSP_expert_callback (GtkWidget *widget, kmdsp_SPM_Control *dspc);
	static int DSP_guru_callback (GtkWidget *widget, kmdsp_SPM_Control *dspc);
	static int DSP_cret_callback (GtkWidget *widget, kmdsp_SPM_Control *dspc);
	static int DSP_slope_callback (GtkWidget *widget, kmdsp_SPM_Control *dspc);
