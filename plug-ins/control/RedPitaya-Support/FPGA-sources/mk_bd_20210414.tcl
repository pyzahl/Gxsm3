...
proc create_hier_cell_PS_data_transport { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net axis_4s_combine_decimate_M_AXIS_CH3 [get_bd_intf_pins McBSP_controller/S_AXIS3] [get_bd_intf_pins axis_4s_combine_decimate/M_AXIS_CH3]
  connect_bd_intf_net -intf_net axis_4s_combine_decimate_M_AXIS_CH4 [get_bd_intf_pins McBSP_controller/S_AXIS4] [get_bd_intf_pins axis_4s_combine_decimate/M_AXIS_CH4]
  ...
  connect_bd_net -net axis_4s_combine_decimate_FIR_next [get_bd_pins axis_4s_combine_decimate/FIR_next] [get_bd_pins axis_FIR_CH1/next_dv] [get_bd_pins axis_FIR_CH2/next_dv]
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net gpio_io_6_x14_1 [get_bd_pins PS/gpio_io_6_x14] [get_bd_pins xlconstant_0/dout]
